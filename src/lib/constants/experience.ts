    ...
    positions: [
      {
        ...
        description: `
• Contributing to the core product team developing an enterprise-grade no-code workflow automation platform, enabling organizations
to build, automate, and orchestrate complex business processes.\n
• Designing and implementing full-stack features using React and Spring Boot, translating business requirements into scalable,
maintainable, and production-ready solutions.\n
• Driving end-to-end feature development across frontend and backend systems, collaborating with cross-functional teams to enhance
platform capabilities, user experience, and system reliability.`,
        skills: [
          "Java",
          "SpringBoot",
          "ReactJS",
